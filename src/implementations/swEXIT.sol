 ...
 */
contract swEXIT is IswEXIT, ERC721EnumerableUpgradeable, Whitelist {
  ...
  function processWithdrawals(
    ...
    uint256 processedRate = AccessControlManager.swETH().swETHToETHRate();
  ...
  function createWithdrawRequest(
    ...
    IERC20Upgradeable(swETH).safeTransferFrom(
      msg.sender,
      address(this),
      amount
    );
